...
newurl=bollettino_covid['data'][:-9].replace('-','')  #elimino il trattino del formato data per avere il formato aaaammgg
...
positivita=bollettino_covid['nuovi_positivi']/(bollettino_covid['tamponi']-tamponi_prec) #calcolo il tasso di positività
